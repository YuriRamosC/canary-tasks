...
function addComponentsFromContext(componentsContext, componentsToHydrate) {
  ...
  var nestedContexts = componentsContext._S_;
...
function getInitComponentsData(out, componentDefs) {
  ...
  const didSerializeComponents = $global.ap_;
  ...
  const TYPE_INDEX = 1;
  const typesLookup = $global.aq_ || ($global.aq_ = new Map());
  let newTypes;
