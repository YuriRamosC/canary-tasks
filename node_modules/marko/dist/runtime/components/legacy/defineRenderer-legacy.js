...
module.exports = function defineRenderer(renderingLogic) {
  ...
  if (!renderer) {
    ...
    renderer = function renderer(input, out) {
      ...
      var isReceivingNewInput = !component || component.ax_;
      ...
      if (!component && componentLookup) {
        ...
        if ((parentComponentDef = componentsContext._R_) && key != null) {
      ...
      if (isReceivingNewInput) {
        ...
        newProps = newProps || component.ay_;
        widgetBody = component._Q_;
        widgetState = component._u_;
      ...
      var templateData = clone(getTemplateData ? getTemplateData(widgetState, newProps, out) : widgetState || newProps);
