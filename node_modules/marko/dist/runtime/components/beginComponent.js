...
module.exports = function beginComponent(componentsContext, component, key, ownerComponentDef, isSplitComponent, isImplicitComponent, existingComponentDef) {
  ...
  var componentDef = existingComponentDef || (componentsContext._R_ = new ComponentDef(component, componentId, componentsContext));

  var ownerIsRenderBoundary = ownerComponentDef && ownerComponentDef._I_;
  var ownerWillRerender = ownerComponentDef && ownerComponentDef._J_ & FLAG_WILL_RERENDER_IN_BROWSER;
  // On the server
  if (!componentsContext.r_ && ownerWillRerender) {
  ...
  componentDef.ae_ = componentsContext.r_;

  if (isSplitComponent === false && out.global.noBrowserRerender !== true) {
    componentDef._J_ |= FLAG_WILL_RERENDER_IN_BROWSER;
    componentsContext.r_ = false;
  }

  if (out.global.oldHydrateNoCreate === true) {
    componentDef._J_ |= FLAG_OLD_HYDRATE_NO_CREATE;
  }
