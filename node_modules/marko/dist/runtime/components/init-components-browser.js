...
var createFragmentNode = require("../vdom/morphdom/fragment").ar_;
...
var keyedElementsByComponentId = domData.H_;
...
function initServerRendered(renderedComponents, doc) {
  ...
  if (renderedComponents.g) {
    meta.at_ = renderedComponents.g;
  }

  if (renderedComponents.t) {
    meta.au_ = meta.au_ ? meta.au_.concat(renderedComponents.t) : renderedComponents.t;
  }
  ...
  (renderedComponents.w || []).map(function (componentDef) {
    componentDef = ComponentDef._O_(componentDef, meta.au_, meta.at_, registry);
...
exports._T_ = initClientRendered;
exports.an_ = initServerRendered;