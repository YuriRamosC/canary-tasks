...
var addDelegatedEventHandler = require("./event-delegation")._E_;
...
ComponentDef.prototype = {
  _M_: function (key) {
    return (this._L_ || (this._L_ = new KeySequence()))._M_(key);
  },
...
ComponentDef._O_ = function (o, types, global, registry) {
  ...
  var component = typeName /* legacy */ && registry._P_(typeName, id, isLegacy);
