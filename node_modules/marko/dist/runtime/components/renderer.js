...
var isServer = componentsUtil.aO_ === true;
...
function handleBeginAsync(event) {
  ...
  asyncOut.c(parentOut.m_, parentOut.o_, parentOut.aN_);
}
      ...
      if (!component) {
        ...
        if (isExisting === true) {
          if (component._l_ === false || component.shouldUpdate(input, component.L_) === false) {
            ...
            out.aQ_(component);
            globalComponentsContext._W_[id] = true;
...
createRendererFunc.aM_ = trackAsyncComponents;