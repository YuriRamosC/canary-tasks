...
var escapeXmlString = escapeXmlHelper.be_;
...
var proto = AsyncStream.prototype = {
  ...
  _doFinish: function () {
    ...
    if (state.writer.end) {
      ...
      state.events.emit("finish", this.bg_());
    }
  },
  ...
  bd_: function (tagName, elementAttrs, key, componentDef, props) {
  ...
  bb_: function (name, elementAttrs, key, componentDef, props) {
