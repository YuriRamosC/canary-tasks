...
var addComponentRootToKeyedElements = componentsUtil.as_;
var normalizeComponentKey = componentsUtil.aV_;
var VElement = require("../vdom").bn_;
...
var keysByDOMNode = domData.ai_;
var componentByDOMNode = domData.G_;
var vElementByDOMNode = domData.ag_;
var detachedByDOMNode = domData.ah_;

var insertBefore = helpers.aX_;
var insertAfter = helpers.aY_;
var nextSibling = helpers.b_;
var firstChild = helpers.a_;
var removeChild = helpers.aZ_;
var createFragmentNode = fragment.ar_;
var beginFragmentNode = fragment.ck_;
...
function morphdom(fromNode, toNode, doc, componentsContext) {
  ...
  function insertVirtualNodeBefore(vNode, key, referenceEl, parentEl, ownerComponent, parentComponent) {
    var realNode = vNode.bM_(doc, parentEl.namespaceURI);
    insertBefore(realNode, referenceEl, parentEl);

    if (vNode.bP_ === ELEMENT_NODE || vNode.bP_ === FRAGMENT_NODE) {
      if (key) {
        keysByDOMNode.set(realNode, key);
        (isAutoKey(key) ? parentComponent : ownerComponent).p_[key] = realNode;
      }

      if (vNode.bX_ !== "textarea") {
  ...
  function morphChildren(fromNode, toNode, parentComponent) {
    ...
    outer: while (curToNodeChild) {
      ...
      curToNodeType = curToNodeChild.bP_;
      curToNodeKey = curToNodeChild.bQ_;
      ...
      var ownerComponent = curToNodeChild.aS_ || parentComponent;
      ...
      if (curToNodeType === COMPONENT_NODE) {
        ...
        if ((matchingFromComponent = existingComponentLookup[component.id]) === undefined) {
          ...
          if (matchingFromComponent.M_ !== curFromNodeChild) {
            if (curFromNodeChild && (fromComponent = componentByDOMNode.get(curFromNodeChild)) && globalComponentsContext._W_[fromComponent.id] === undefined) {
        ...
        // up elements
        curToNodeKey = (keySequences[referenceComponent.id] || (keySequences[referenceComponent.id] = new KeySequence()))._M_(curToNodeKey);
        ...
        if (curFromNodeKey === curToNodeKey) {
          ...
          if ((matchingFromEl = referenceComponent.p_[curToNodeKey]) === undefined) {
            if (isHydrate === true && curFromNodeChild) {
              if (curFromNodeChild.nodeType === ELEMENT_NODE && caseInsensitiveCompare(curFromNodeChild.nodeName, curToNodeChild.bX_ || "")) {
                curVFromNodeChild = virtualizeElement(curFromNodeChild);
                curVFromNodeChild.bX_ = curToNodeChild.bX_;
                keysByDOMNode.set(curFromNodeChild, curToNodeKey);
                morphEl(curFromNodeChild, curVFromNodeChild, curToNodeChild, curToNodeKey, ownerComponent, parentComponent);
                curToNodeChild = toNextSibling;
                curFromNodeChild = fromNextSibling;
                continue;
              } else if (curToNodeChild.bP_ === FRAGMENT_NODE && curFromNodeChild.nodeType === COMMENT_NODE) {
            ...
            if (!curToNodeChild.bR_) {
              ...
              if (compareNodeNames(curVFromNodeChild, curToNodeChild)) {
                if (fromNextSibling === matchingFromEl) {
                  ...
                  if (toNextSibling && toNextSibling.bQ_ === curFromNodeKey) {
                    // Single element swap
      ...
      while (curFromNodeChild) {
        ...
        if (fromComponent = componentByDOMNode.get(curFromNodeChild)) {
          ...
          if (!globalComponentsContext._W_[fromComponent.id]) {
            destroyComponent(fromComponent);
          }
          ...
          if (curFromNodeType === ELEMENT_NODE) {
            ...
            if (curVFromNodeChild === undefined) {
              if (isHydrate === true) {
                ...
                if (caseInsensitiveCompare(curVFromNodeChild.bX_, curToNodeChild.bX_)) {
                  curVFromNodeChild.bX_ = curToNodeChild.bX_;
                }
              } else {
            ...
            } else if (curFromNodeKey = curVFromNodeChild.bQ_) {
            ...
            if (curFromNodeChild.nodeValue !== curToNodeChild.bO_) {
              curFromNodeChild.nodeValue = curToNodeChild.bO_;
            }
          }
        }
    ...
    if (fromNode.cj_) {
      ...
      while (curFromNodeChild && curFromNodeChild !== fragmentBoundary) {
        ...
        if (!curFromNodeKey || isAutoKey(curFromNodeKey)) {
          ...
          referenceComponent = curVFromNodeChild && curVFromNodeChild.aS_;
        }
  ...
  function morphEl(fromEl, vFromEl, toEl, toElKey, ownerComponent, parentComponent) {
    ...
    var constId = toEl.bZ_;
    if (constId !== undefined && vFromEl.bZ_ === constId) {
      return;
    }
