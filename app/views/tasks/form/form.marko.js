...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=form-group><label for=titulo>Titulo:</label><input type=text id=titulo name=titulo" +
    ...
    " placeholder=\"coloque o tipo\" class=form-control></div><div class=form-group><label for=descricao>Descrição:</label><textarea cols=20 rows=10 id=descricao name=descricao placeholder=\"fale sobre o task\" class=form-control>" +
