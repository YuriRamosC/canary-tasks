...
function render(input, out, __component, component, state) {
  ...
  marko_forOf(data.tasks, function(task) {
    ...
    out.w("<tr" +
      ...
      marko_attr("title", task.descricao) +
      "><td>" +
      ...
      "</td><td>" +
      marko_escapeXml(task.altura) +
      " x " +
      marko_escapeXml(task.largura) +
      " " +
      marko_escapeXml(task.unid) +
      ...
      " data-type=remocao>Remover</a></td><td><a class=button-link" +
      marko_attr("href", "/tasks/arq/" + (task.id == null ? "" : task.id)) +
      ">Adicionar Arquivos</a></td></tr>");
  });
